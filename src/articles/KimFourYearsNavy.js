    ...
    <Grid celled='internally' columns='equal' stackable>
        ...
        <Grid.Row textAlign='left'>
            <Grid.Column  style={{ paddingBottom: '1em', paddingTop: '.5em' }} >
	            ...
	            <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="U.S. Naval Cargo Handling Battalion One" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                The Chief took me under his wing.  The Seaman test was coming up soon, but I hadn't completed my correspondence courses.  He obtained someone else’s answers and had me copy them.  I took the test, passed and was advanced to seaman.
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                We started out on Friday at noon with the Mammas and Papas singing "Monday, Monday" on the radio.  We dropped one guy off in North Carolina, one in South Carolina and at one in the morning we arrived in Brunswick.  The Bus Station was closed so the driver dropped me off by the highway.   So at one o’clock in the morning I found myself hitch hiking to Florida.
                <br/>
                <br/>
	            ...
	            <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="USS Great Sitkin  AE-17" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Me" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Liberty on the Italian Riviera" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Don, Pat Ranahan, &amp; Kim" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                The next day the first class petty officer came and asked me how I was treated.  I said, "Fine."  He told me I surprised everyone.  They thought I was going to be a hardcase and had planned to make me work down in the bilge’s.  I had done the right thing.  But, I hadn't forgotten about Humpfrey.
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Palma" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                That’s the way it ended.  I found out a year later that after the Mississinewa sailed, he really tore up the Disbursing office looking for the film.  Paul Ryder had made a mistake and it cost him a roll of shots he could never replace.   I bought a new pillow.  In looking back, I should have sent him the pictures.
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="USS Neosho  Ao-143" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="John Harris, Kim Richardson, &amp; Don Ranahan" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Don Ranahan, Kim Richardson, &amp; Pat Ranahan" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                One of the Nurses came to my rescue and told me that at four o’clock, a man came by with a cart.  He sold crackers, candy, and cokes. But, most importantly, paperback books.  The selection wasn't good but at least he had westerns.  I must have read twenty while I was there.
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                Although I was too sick to go back to the fleet, they said I was well enough to work around the hospital.  One day I was assigned to fill all the patients water pitchers in the dependence wing of the hospital.  I went around with a little cart and collected all the pitchers.  They had the patient’s name marked on a piece of tape on the side of the pitcher.
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="USS Truckee AO-147 in Malta" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="Kim &amp; Tina" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                Pat ended up being kept in the Navy for a couple of months after his enlistment was over.  Then they gave him a general discharge.  If he hadn't tried to carry someone else’s bottle on board ship, he would have been home free and clear.
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="John Harris &amp; Kim in Gibralta" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                ...
                <SimpleReactLightbox>
                    <SRLWrapper>
                        <img src={oliver1932} class="familyTree" alt="
                        Ships" />
                    </SRLWrapper>
                </SimpleReactLightbox>
                </p>
