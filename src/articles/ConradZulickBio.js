...
import zulick86 from '../images/articlePictures/zulick86.png'
        ...
        <Grid.Row textAlign='left'>
            <Grid.Column  style={{ paddingBottom: '1em', paddingTop: '.5em' }} >
                ...
                <div class="column">
                    ...
                    <img src={zulick89} class="articlePhoto" alt="1885 - 1889 - Taken sometime during his governership" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={zulick86} class="articlePhoto" alt="1886 - April 3. An article about his appointment printed in a Pennyslvannia Newspaper" />
                </div>
                <br/>
                <br/>
...
export default ConradZulickBio