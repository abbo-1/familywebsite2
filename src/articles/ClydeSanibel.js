    ...
    <Segment  style={{ padding: '0em 0em' }} vertical>
        <Grid celled='internally' columns='equal' stackable>
            <Grid.Row textAlign='center'>
                ...
                <br/>
                    <Header as='h3' style={{ fontSize: '2em' }}>Clyde on Sanibel Island <br/> (1911 - 1926) </Header>
                    <br/>
                </Grid.Column>
            </Grid.Row>
            ...
            <Grid.Row textAlign='left'>
                <Grid.Column  style={{ paddingBottom: '1em', paddingTop: '.5em' }} >
                    ...
                    <br/>
                    <br/>
                    They bought their food at Bailey’s Store or by boat from Fort Myers.  They also fished a lot, hunted rabbits and clams.  The rest of what they ate was grown by Oliver. They attended a one room school house.  All grades were held there. Some grades had as little as two or three kids in them.  They would sit in different areas.  Grade by grade would go up front; the teacher would instruct them on their lesson and would go back to their space to do their lessons as the other grades took their turn.
                    <br/>
                    <br/>
