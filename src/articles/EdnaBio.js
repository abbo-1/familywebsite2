...
import ednaBurial081 from '../images/articlePictures/ednaBurial081.png'
import ednaBurial08 from '../images/articlePictures/ednaBurial08.png'
    ...
    <Grid celled='internally' columns='equal' stackable>
        ...
        <Grid.Row textAlign='left'>
            <Grid.Column  style={{ paddingBottom: '1em', paddingTop: '.5em' }} >
                ...
                <br/>
                Edna was born on March 25, 1923 in Brooklyn, New York. She was the baby of the family. She remembered having to wait downstairs every evening for Gus (her brother) to come home to ask for a penny. He usually gave her two, which she would use to buy a block of chocolate at the candy store.
                <br/>
                <br/>
                ...
                <SimpleReactLightbox>
                    ...
                    <img src={edna27} class="articlePhoto" alt="1927 -  Edna Frank" />
                    </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={maizieEdnaJo31} class="articlePhoto" alt="1931 - Maizie, Edna, &amp; Jo Frank" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={edna41} class="articlePhoto" alt="1941 - Edna" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={edna45} class="articlePhoto" alt="1944 - Edna on Sanibel Island" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={clydeEdnaWedding} class="articlePhoto" alt="1946 - Clyde &amp; Edna at their wedding " />
                </div>
                <br/>
                ...
                <br/>
                <br/>
                On March 16, 1958 Edna had Jay and on November 5, 1959 Edna had Karen.
                <br/>
                <br/>
                In July 1960 Edna took all four of her children to New York on the train. They stayed for a month with her sister, Jo and her family. They spent time with Helen, Nana, and the Richards. On Wednesday of each week they had dinner with her brother Gus and his wife Dottie.
                <br/>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={frankKids79} class="articlePhoto" alt="1979 - The Frank Kids. Gus, Helen, Josephine, Maizie, &amp; Edna" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={ednaClyde88} class="articlePhoto" alt="1988 - Edna &amp; Clyde" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={clydeEdna96} class="articlePhoto" alt="1996 - January 27th. Clyde &amp; Edna" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={family07} class="articlePhoto" alt="2007 - May 13th. Marissa, Carol, Scott, Megan, Kevin, Gail, Kim, Edna, Kelly, Jay, Autumn, Karen, Lucille, &amp; Matt" />
                </div>
                <br/>
                ...
                <div class="column">
                    {/* <SRLWrapper options={options}> */}
                    <img src={edna08} class="articlePhoto" alt="2008 - March 23. Edna's 85th Birthday" />
                </div>
                <br/>
                ...
                <div class="column">
                    <img src={ednaBurial081} class="articlePhoto" alt="2008 – Edna's funeral" />
                </div>
                <div class="column">
                    <img src={ednaBurial08} class="articlePhoto" alt="2008 – Karen, Jay, Gail, &amp; Kim" />
                </div>
                </div>
                    </SRLWrapper>
                </SimpleReactLightbox>
